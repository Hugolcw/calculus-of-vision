...
# - Smoke test:       python tools/smoke_all.py --file sobel_v14_full_EN.py --scene FullSobelVideo --quality pql
# Import the versionless helper package per the new manim_lib architecture
